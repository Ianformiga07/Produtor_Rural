...
<table width="100%" height="100%" border="0">
  <tr>
    <td><form name="form1" method="post" action="consulta.asp">
        <table width="70%" border="0" align="center">
          <tr> 
            <td colspan="2"><div align="center"><font size="7" face="Verdana, Arial, Helvetica, sans-serif">Consulta 
          ...
          <tr> 
            <td colspan="2"><div align="center">
                <input name="Submit" type="submit" class="btn" value="Consultar Filme">
              </div></td>
          </tr>
        </table>
      </form></td>
